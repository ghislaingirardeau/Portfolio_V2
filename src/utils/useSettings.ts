...
export const PACMAN_LEVEL_GRID = ref([
  ...
  },
  {
    ...
    y: [
      ...
      { key: 'e', isBlock: false, point: 10 },
      { key: 'f', isBlock: true, point: 10 },
      { key: 'g', isBlock: true, point: 10 },
      { key: 'h', isBlock: true, point: 10 },
    ],
  },
  {
    x: 3,
  ...
  },
  {
    ...
    y: [
      ...
      { key: 'b', isBlock: false, point: 10 },
      { key: 'c', isBlock: false, point: 10 },
      { key: 'd', isBlock: true, point: 10 },
      { key: 'e', isBlock: true, point: 10 },
      { key: 'f', isBlock: false, point: 10 },
      { key: 'g', isBlock: false, point: 10 },
      { key: 'h', isBlock: false, point: 10 },
    ],
  ...
  },
  {
    x: 7,
    y: [
      { key: 'a', isBlock: true, point: 10 },
      { key: 'b', isBlock: true, point: 10 },
      { key: 'c', isBlock: true, point: 10 },
      { key: 'd', isBlock: true, point: 10 },
      { key: 'e', isBlock: true, point: 10 },
      { key: 'f', isBlock: false, point: 10 },
      { key: 'g', isBlock: true, point: 10 },
